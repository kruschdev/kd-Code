import { type EnvironmentId, type MessageId, type TurnId } from "@krusch/contracts";
import {
  createContext,
  memo,
  use,
...
import { type TimestampFormat } from "@krusch/contracts/settings";
...
export const MessagesTimeline = memo(function MessagesTimeline({
  ...
  useEffect(() => {
    ...
    if (rows.length === 0 || rows.length <= previousRowCount) {
      return;
    }
