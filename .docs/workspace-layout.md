...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@krusch/shared/git`, `@krusch/shared/DrainableWorker`) — no barrel index.
