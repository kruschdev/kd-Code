...
import { NetService } from "@krusch/shared/Net";
...
const MODE_ARGS = {
  dev: [
    ...
    "dev",
    "--ui=tui",
    "--filter=@krusch/contracts",
    "--filter=@krusch/web",
    "--parallel",
  ],
  "dev:web": ["run", "dev", "--filter=@krusch/web"],
  "dev:desktop": ["run", "dev", "--filter=@krusch/desktop", "--filter=@krusch/web", "--parallel"],
